    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mt-5 text-right">
          <button
            type="submit"
            className="md:text-sm leading-5 inline-flex items-center cursor-pointer transition-colors duration-150 font-medium text-center justify-center border-0 border-transparent rounded-md placeholder-white focus-visible:outline-none focus:outline-none new-bg text-white px-5 md:px-6 lg:px-8 py-2 md:py-3 lg:py-3 hover:text-white hover:bg-blue-600 h-12 mt-1 text-sm lg:text-sm w-full sm:w-auto"
          >
            Change Password
          </button>
        </div>
