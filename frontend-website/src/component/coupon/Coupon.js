            ...
            <div className="md:border-l-2 lg:border-l-2 border-dashed lg:w-1/3 md:w-1/3 relative px-4">
              <div className="info flex items-center">
                <div className="w-full">
                  <div className="block">
                    <div className="font-serif border border-dashed bg-emerald-50 py-1 border-cyan-300 rounded-lg text-center block">
                      <CopyToClipboard
                  ...
                  <p className="text-xs leading-4 text-gray-500 mt-2">
                    * This coupon apply when shopping more then{' '}
                    <span className="font-bold"> Rs. {coupon.minimumAmount}</span>{' '}
                  </p>
                </div>
              </div>
            </div>
