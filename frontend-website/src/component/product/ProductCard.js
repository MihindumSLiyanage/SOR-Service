          ...
          <div className="flex justify-between items-center text-heading text-sm sm:text-base space-s-2 md:text-base lg:text-xl">
            ...
            {inCart(product._id) ? (
              ...
              <button
                ...
                aria-label="cart"
                className="h-9 w-9 flex items-center justify-center border border-gray-200 rounded text-blue-500 hover:border-cyan-500 hover:bg-cyan-500 hover:text-white transition-all"
              >
                {' '}
