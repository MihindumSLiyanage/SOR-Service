    ...
    <>
      ...
      {!loading && (
        <div className="mb-4 mt-3 flex justify-between">
          ...
          <ReactToPrint
            trigger={() => (
              <button className="flex items-center text-sm leading-5 transition-colors duration-150 font-medium focus:outline-none px-5 py-2 rounded-md text-white bg-blue-500 border border-transparent active:bg-blue-600 hover:bg-greblueen-600 focus:ring focus:ring-purple-300 w-auto">
                Print Invoice{' '}
                <span className="ml-2">
                  <FiPrinter />
                </span>
