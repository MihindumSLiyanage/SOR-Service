export const doughnutLegends = [
  { title: 'Audio', color: 'bg-green-500' },
  { title: 'Batteries', color: 'bg-blue-500' },
  { title: 'Exterior', color: 'bg-orange-500' },
  { title: 'Interior', color: 'bg-indigo-500' },
];

export const lineLegends = [
  { title: 'NotPaid', color: 'bg-teal-600' },
...
export const doughnutOptions = {
  data: {
    ...
    labels: ['Audio', 'Batteries', 'Exterior', 'Interior'],
  },
  options: {
    responsive: true,
    cutoutPercentage: 80,
